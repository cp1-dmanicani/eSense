...
/**
 * ONLINE MODE
 * An adapter class that handles the RecyclerView component of AllUsers Fragment.
 */
public class OnlineUser_RecyclerAdapter extends FirebaseRecyclerAdapter<Friends_ModelClass, OnlineUser_RecyclerAdapter.UsersViewHolder> {
    Activity activity;
     ...
     * @param options
     */
    public OnlineUser_RecyclerAdapter(@NonNull FirebaseRecyclerOptions<Friends_ModelClass> options, Context context, Activity activity) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull OnlineUser_RecyclerAdapter.UsersViewHolder holder, int position, @NonNull Friends_ModelClass model) {
        ...
        userReference.child(friend_uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Intent intent = new Intent(context, OnlineChat_Basic.class);
                intent.putExtra("userName", userName);
                intent.putExtra("otherName", friendUserName);
                intent.putExtra("otherNameID", friendUUID);
    ...
    public UsersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.onlinechat_friends_single_layout,
                parent, false);
        return new OnlineUser_RecyclerAdapter.UsersViewHolder(v);
    }
