...
/**
 * ONLINE MODE
 * An activity that list all the user's friends before starting the Online Chat activity.
 */
public class OnlineChatUsers extends AppCompatActivity {

    private OnlineUser_RecyclerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.online_chat_users);
    ...
    private void init() {
        ...
        mFriendsList = findViewById(R.id.usersList);
    ...
    private void setupRecyclerView() {
        ...
        adapter = new OnlineUser_RecyclerAdapter(options, OnlineChatUsers.this, OnlineChatUsers.this);
    ...
    private void displayToast (String message) {
        Toast.makeText(OnlineChatUsers.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void LogOutUser() {
        mAuth.signOut();
        Intent intentSignOut = new Intent(OnlineChatUsers.this, OnlineLogin.class);
    ...
    private void processSearch(String s) {
        ...
        adapter = new OnlineUser_RecyclerAdapter(optionsQuery, this, this);
        adapter.startListening();
        mFriendsList.setAdapter(adapter);
    }
}