 ...
 * use listener chain: WSN_SerialSocket -> WSNSerialService -> UI fragment
 */
public class WSNSerialService extends Service implements WSN_SerialListener {

    class SerialBinder extends Binder {
        WSNSerialService getService() { return WSNSerialService.this; }
    }
    ...
    private WSN_SerialSocket socket;
    private WSN_SerialListener listener;
    private boolean connected;

    /**
     * Lifecylce
     */
    public WSNSerialService() {
     ...
     * Api
     */
    public void connect(WSN_SerialSocket socket) throws IOException {
        socket.connect(this);
        this.socket = socket;
        connected = true;
    }
    ...
    public void attach(WSN_SerialListener listener) {
    ...
    private void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel nc = new NotificationChannel(WSN_Constant.NOTIFICATION_CHANNEL, "Background service", NotificationManager.IMPORTANCE_LOW);
            nc.setShowBadge(false);
            NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(nc);
        }
        Intent disconnectIntent = new Intent()
                .setAction(WSN_Constant.INTENT_ACTION_DISCONNECT);
        Intent restartIntent = new Intent()
                .setClassName(this, WSN_Constant.INTENT_CLASS_MAIN_ACTIVITY)
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, WSN_Constant.NOTIFICATION_CHANNEL)
        ...
        startForeground(WSN_Constant.NOTIFY_MANAGER_START_FOREGROUND_SERVICE, notification);
    }
