...
public class WSN_DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestBluetoothPermissionLauncherForRefresh = registerForActivityResult(
                ...
                granted -> WSN_BluetoothUtil.onPermissionsResult(this, granted, this::refresh));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.bt_settings) {
            ...
            if(WSN_BluetoothUtil.hasPermissions(this, requestBluetoothPermissionLauncherForRefresh))
                refresh();
            return true;
        } else {
    ...
    void refresh() {
        ...
        if(bluetoothAdapter != null) {
            ...
            if(!permissionMissing) {
                ...
                Collections.sort(listItems, WSN_BluetoothUtil::compareTo);
            }
        }
        if(bluetoothAdapter == null)
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        Fragment fragment = new WSN_TerminalFragment();
